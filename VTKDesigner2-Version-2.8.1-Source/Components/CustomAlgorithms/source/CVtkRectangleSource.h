...
#ifndef CVTKRECTANGLESOURCE_VIS_NODE_H
#define CVTKRECTANGLESOURCE_VIS_NODE_H
...
class CVtkRectangleSource : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_PROPERTY(double Breadth READ breadth WRITE setBreadth)
