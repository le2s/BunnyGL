...
#ifndef C_TERRAIN_IMAGE_FILE_LOADER_H
#define C_TERRAIN_IMAGE_FILE_LOADER_H

#include <QObject>
#include "IDataFileLoader.h"

struct CTerrainImageFileLoaderData;
class CTerrainImageFileLoader : public QObject, virtual public IDataFileLoader
{
    Q_OBJECT
    Q_INTERFACES(IDataFileLoader)

public:
    CTerrainImageFileLoader(QObject* parent=0);
    ~CTerrainImageFileLoader();
