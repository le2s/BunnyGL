...
#ifndef C_VTK_DATA_FILE_LOADER_H
#define C_VTK_DATA_FILE_LOADER_H

#include <QObject>
#include "IDataFileLoader.h"

struct CVtkDataFileLoaderData;
class CVtkDataFileLoader : public QObject, virtual public IDataFileLoader
{
	Q_OBJECT
	Q_INTERFACES(IDataFileLoader)

public:
	CVtkDataFileLoader(QObject* parent=0);
	~CVtkDataFileLoader();
