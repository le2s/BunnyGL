...
#ifndef CVTKFRACTALTERRAINSOURCE_VIS_NODE_H
#define CVTKFRACTALTERRAINSOURCE_VIS_NODE_H
...
class CVtkFractalTerrainSource : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkFractalTerrainSource();
    ~CVtkFractalTerrainSource();

    void setNumberOfIterations(int count);
    int numberOfIterations() const;

    Q_INVOKABLE void regenerate();

protected slots:
    void command_Regenerate();
...
private:
    CVtkFractalTerrainSourceData* d;
};
