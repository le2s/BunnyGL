...
#ifndef CVTKMENGERSPONGESOURCE_VIS_NODE_H
#define CVTKMENGERSPONGESOURCE_VIS_NODE_H
...
class CVtkMengerSpongeSource : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
