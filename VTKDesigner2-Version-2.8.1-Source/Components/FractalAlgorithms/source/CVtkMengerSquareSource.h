...
#ifndef CVTKMENGERSQUARESOURCE_VIS_NODE_H
#define CVTKMENGERSQUARESOURCE_VIS_NODE_H
...
class CVtkMengerSquareSource : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
