...
#ifndef CVTKSIERPINSKIPYRAMIDSOURCE_VIS_NODE_H
#define CVTKSIERPINSKIPYRAMIDSOURCE_VIS_NODE_H
...
class CVtkSierpinskiPyramidSource : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    CVtkSierpinskiPyramidSourceData* d;
};
