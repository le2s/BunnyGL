...
#ifndef CVTKSIERPINSKITRIANGLESOURCE_VIS_NODE_H
#define CVTKSIERPINSKITRIANGLESOURCE_VIS_NODE_H
...
class CVtkSierpinskiTriangleSource : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    CVtkSierpinskiTriangleSourceData* d;
};
