...
#ifndef CVTKIMAGEGAUSSIANSMOOTH_VIS_NODE_H
#define CVTKIMAGEGAUSSIANSMOOTH_VIS_NODE_H
...
class CVtkImageGaussianSmooth : public CVtkThreadedImageAlgorithm
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkImageGaussianSmooth();
    ~CVtkImageGaussianSmooth();

    Q_PROPERTY(QList<QVariant> StandardDeviations READ standardDeviations WRITE setStandardDeviations)
    void setStandardDeviations(const QList<QVariant>& dev);
    QList<QVariant> standardDeviations() const;

    Q_PROPERTY(QList<QVariant> RadiusFactors READ radiusFactors WRITE setRadiusFactors)
    void setRadiusFactors(const QList<QVariant>& val);
    QList<QVariant> radiusFactors() const;

    Q_PROPERTY(int Dimensionality READ dimensionality WRITE setDimensionality)
