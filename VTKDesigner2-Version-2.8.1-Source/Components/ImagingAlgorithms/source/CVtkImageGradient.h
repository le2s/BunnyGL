...
#ifndef CVTKIMAGEGRADIENT_VIS_NODE_H
#define CVTKIMAGEGRADIENT_VIS_NODE_H
...
class CVtkImageGradient : public CVtkThreadedImageAlgorithm
#ifdef ENABLE_ADVANCED_PROPERTIES
