...
#ifndef CVTKIMAGEGRADIENTMAGNITUDE_VIS_NODE_H
#define CVTKIMAGEGRADIENTMAGNITUDE_VIS_NODE_H
...
class CVtkImageGradientMagnitude : public CVtkThreadedImageAlgorithm
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkImageGradientMagnitude();
    ~CVtkImageGradientMagnitude();

    Q_PROPERTY(bool HandleBoundaries READ isHandleBoundaries WRITE setHandleBoundaries)
    void setHandleBoundaries(bool val);
    bool isHandleBoundaries() const;
...
private:
    CVtkImageGradientMagnitudeData* d;
};
