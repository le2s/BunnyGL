...
#ifndef CVTKIMAGEMEDIAN3D_VIS_NODE_H
#define CVTKIMAGEMEDIAN3D_VIS_NODE_H
...
class CVtkImageMedian3D : public CVtkThreadedImageAlgorithm
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    ...
    Q_INVOKABLE void setKernelSize(int size0, int size1, int size2);
    Q_INVOKABLE int numberOfElements() const;
