...
#ifndef CVTKDATAOBJECTTOTABLE_VIS_NODE_H
#define CVTKDATAOBJECTTOTABLE_VIS_NODE_H
...
class CVtkDataObjectToTable : public CVtkTableAlgorithm
#ifdef ENABLE_ADVANCED_PROPERTIES
