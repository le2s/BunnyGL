...
#ifndef CVTKFIXEDWIDTHTEXTREADER_VIS_NODE_H
#define CVTKFIXEDWIDTHTEXTREADER_VIS_NODE_H
...
class CVtkFixedWidthTextReader : public CVtkTableAlgorithm
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    CVtkFixedWidthTextReaderData* d;
};
