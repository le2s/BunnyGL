...
#ifndef CVTKQTABSTRACTMODELADAPTER_VIS_NODE_H
#define CVTKQTABSTRACTMODELADAPTER_VIS_NODE_H
...
class CVtkQtAbstractModelAdapter : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
protected:
    ...
    virtual void setModelAdapter(vtkQtAbstractModelAdapter* adapter);

private:
    CVtkQtAbstractModelAdapterPrivate* d;
};
