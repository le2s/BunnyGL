...
#ifndef CVTKQTTABLEMODELADAPTER_VIS_NODE_H
#define CVTKQTTABLEMODELADAPTER_VIS_NODE_H
...
class CVtkQtTableModelAdapter : public CVtkQtAbstractModelAdapter
#ifdef ENABLE_ADVANCED_PROPERTIES
...
protected:
    ...
    void setModelAdapter(vtkQtAbstractModelAdapter* adapter);

private:
    CVtkQtTableModelAdapterData* d;
};
