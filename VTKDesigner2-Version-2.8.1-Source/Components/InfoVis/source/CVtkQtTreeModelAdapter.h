...
#ifndef CVTKQTTREEMODELADAPTER_VIS_NODE_H
#define CVTKQTTREEMODELADAPTER_VIS_NODE_H
...
class CVtkQtTreeModelAdapter : public CVtkQtAbstractModelAdapter
#ifdef ENABLE_ADVANCED_PROPERTIES
