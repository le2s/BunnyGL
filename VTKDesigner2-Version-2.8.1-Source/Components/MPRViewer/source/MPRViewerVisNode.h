...
#ifndef MPRVIEWERVISNODE_VIS_NODE_H
#define MPRVIEWERVISNODE_VIS_NODE_H
...
class MPRViewerVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    ...
    MPRViewerWidget* viewerWidget() const;
