...
#ifndef QIMAGETOVTKIMAGECONVERTERVISNODE_VIS_NODE_H
#define QIMAGETOVTKIMAGECONVERTERVISNODE_VIS_NODE_H
...
class QImageToVtkImageConverterVisNode : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    QImageToVtkImageConverterVisNode();
    ~QImageToVtkImageConverterVisNode();
...
protected slots:
    void inputQImageChanged();

private:
    QImageToVtkImageConverterVisNodeData* d;
};
