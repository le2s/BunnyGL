...
#ifndef C_VTK_DATA_SET_ALGORITHM_H
#define C_VTK_DATA_SET_ALGORITHM_H

#include "CVtkAlgorithm.h"
#include "vtkDataSetAlgorithm.h"
#include "CVtkDataSet.h"

class CVtkDataSetAlgorithm : public CVtkAlgorithm
{
    Q_OBJECT
    DECLARE_VTK_OBJECT
...
private:
    vtkDataSetAlgorithm* m_vtkDataSetAlgorithm;
    CVtkDataSet m_polyData;
};
