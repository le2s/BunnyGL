...
#ifndef C_VTK_CUSTOM_IMAGE_SOURCE_H
#define C_VTK_CUSTOM_IMAGE_SOURCE_H
...
class CVtkCustomImageSource : public CVtkAlgorithm
{
    Q_OBJECT
    DECLARE_VTK_OBJECT

public:
    CVtkCustomImageSource();
    ~CVtkCustomImageSource();
...
private:
    friend class vtkCustomImageSource;
    vtkImageAlgorithm * m_vtkImageAlgorithm;
    CScriptableVtkImageData* m_imageDataAccess;
    CVtkImageData m_imageData;
    bool isRequestingData;
};

class vtkCustomImageSource : public vtkImageAlgorithm 
{
public:
    static vtkCustomImageSource* New();

    vtkSetMacro(CustomImageSource, CVtkCustomImageSource*);
    vtkGetMacro(CustomImageSource, CVtkCustomImageSource*);
...
private:
    vtkCustomImageSource(const vtkCustomImageSource&);  // Not implemented.
    void operator=(const vtkCustomImageSource&);  // Not implemented.
    CVtkCustomImageSource* CustomImageSource;
};
