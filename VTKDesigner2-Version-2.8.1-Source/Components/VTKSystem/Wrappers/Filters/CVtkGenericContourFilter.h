...
#ifndef C_VTK_GENERIC_CONTOUR_FILTER_H
#define C_VTK_GENERIC_CONTOUR_FILTER_H

#include "vtkGenericContourFilter.h"
#include "CVtkPolyDataFilter.h"

class CVtkGenericContourFilter : public CVtkPolyDataFilter
{
    Q_OBJECT
...
private:
    vtkGenericContourFilter *m_vtkGenericContourFilter;
};
