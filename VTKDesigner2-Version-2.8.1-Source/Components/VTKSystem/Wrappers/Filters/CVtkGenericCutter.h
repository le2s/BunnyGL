...
** 
****************************************************************************/
#ifndef C_VTK_GENERIC_CUTTER_H
#define C_VTK_GENERIC_CUTTER_H

#include "vtkGenericCutter.h"
#include "CVtkPolyDataFilter.h"

class CVtkGenericCutter : public CVtkPolyDataFilter
{
    Q_OBJECT
...
private:
    vtkGenericCutter *m_vtkGenericCutter;
};
#endif//C_VTK_GENERIC_CUTTER_H