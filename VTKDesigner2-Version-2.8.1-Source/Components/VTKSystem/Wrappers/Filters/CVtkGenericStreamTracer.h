...
#ifndef C_VTK_GENERIC_STREAM_TRACER_H
#define C_VTK_GENERIC_STREAM_TRACER_H
...
class CVtkGenericStreamTracer : public CVtkPolyDataFilter
{
    Q_OBJECT
    Q_ENUMS(Solvers)
    Q_ENUMS(Units)
...
private:
    vtkGenericStreamTracer *m_vtkGenericStreamTracer;
};
