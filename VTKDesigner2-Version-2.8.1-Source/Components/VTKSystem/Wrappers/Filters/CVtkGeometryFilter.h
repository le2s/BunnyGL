...
#ifndef C_VTK_GEOMETRY_FILTER_H
#define C_VTK_GEOMETRY_FILTER_H

#include "CVtkPolyDataFilter.h"
#include "vtkGeometryFilter.h"


class CVtkGeometryFilter : public CVtkPolyDataFilter
{
    Q_OBJECT
    ...
    Q_PROPERTY(int CellMinimum READ cellMinimum WRITE setCellMinimum)
...
public:
    ...
    int     isExtentClipping() const;

    void     setPointMinimum(int t);
    int     pointMinimum() const;

    void     setPointMaximum (int t);
    int     pointMaximum() const;

    void     setCellMinimum (int t);
    int     cellMinimum () const;

    void     setCellMaximum (int t);
