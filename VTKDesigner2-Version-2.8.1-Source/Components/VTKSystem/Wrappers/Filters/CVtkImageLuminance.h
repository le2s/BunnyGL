...
#ifndef C_VTK_IMAGE_LUMINANCE_H
#define C_VTK_IMAGE_LUMINANCE_H

#include "vtkImageLuminance.h"
#include "CVtkThreadedImageAlgorithm.h"

class CVtkImageLuminance : public CVtkThreadedImageAlgorithm
{
    Q_OBJECT
    DECLARE_VTK_OBJECT
...
private:
    vtkImageLuminance* m_vtkImageLuminance;
};

#endif//C_VTK_IMAGE_LUMINANCE_H
