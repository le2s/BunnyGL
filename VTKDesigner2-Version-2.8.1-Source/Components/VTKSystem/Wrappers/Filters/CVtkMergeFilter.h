...
#ifndef C_VTK_MERGE_FILTER_H
#define C_VTK_MERGE_FILTER_H

#include "CVtkDataSetAlgorithm.h"
#include "vtkMergeFilter.h"

class CVtkMergeFilter : public CVtkDataSetAlgorithm
{
    Q_OBJECT
    DECLARE_VTK_OBJECT
...
private:
    vtkMergeFilter* m_vtkMergeFilter;
};

#endif //CVtkMergeFilter
