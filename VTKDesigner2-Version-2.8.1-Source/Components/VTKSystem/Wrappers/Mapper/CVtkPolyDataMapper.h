...
#ifndef C_VTK_POLYDATA_MAPPER_H
#define C_VTK_POLYDATA_MAPPER_H

#include "CVtkAlgorithm.h"
#include "vtkPolyDataMapper.h"
#include "CVtkPolyDataMapperData.h"

class CVtkPolyDataMapper : public CVtkAlgorithm
{
    Q_OBJECT
...
private:
    ...
    CVtkPolyDataMapperData m_vtkPolyDataMapperOutput;
};
