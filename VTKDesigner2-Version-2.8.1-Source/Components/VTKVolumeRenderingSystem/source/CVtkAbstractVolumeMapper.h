...
#ifndef CVTKABSTRACTVOLUMEMAPPER_VIS_NODE_H
#define CVTKABSTRACTVOLUMEMAPPER_VIS_NODE_H
...
class CVtkAbstractVolumeMapper : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkAbstractVolumeMapper();
    ~CVtkAbstractVolumeMapper();

    Q_INVOKABLE QList<double> bounds() const;
...
private:
    CVtkAbstractVolumeMapperData* d;
};
