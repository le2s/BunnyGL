...
#ifndef CVTKCELLCENTERDEPTHSORT_VIS_NODE_H
#define CVTKCELLCENTERDEPTHSORT_VIS_NODE_H
...
class CVtkCellCenterDepthSort : public CVtkVisibilitySort
#ifdef ENABLE_ADVANCED_PROPERTIES
