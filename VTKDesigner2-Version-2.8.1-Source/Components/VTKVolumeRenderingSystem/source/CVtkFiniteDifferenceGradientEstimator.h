...
#ifndef CVTKFINITEDIFFERENCEGRADIENTESTIMATOR_VIS_NODE_H
#define CVTKFINITEDIFFERENCEGRADIENTESTIMATOR_VIS_NODE_H
...
class CVtkFiniteDifferenceGradientEstimator : public CVtkEncodedGradientEstimator
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_PROPERTY(int SampleSpacingInVoxels READ sampleSpacingInVoxels WRITE setSampleSpacingInVoxels)

public:
    CVtkFiniteDifferenceGradientEstimator();
    ~CVtkFiniteDifferenceGradientEstimator();

    void setSampleSpacingInVoxels(int val);
    int sampleSpacingInVoxels() const;
...
private:
    CVtkFiniteDifferenceGradientEstimatorData* d;
};
