...
#ifndef CVTKFIXEDPOINTVOLUMERAYCASTMAPPER_VIS_NODE_H
#define CVTKFIXEDPOINTVOLUMERAYCASTMAPPER_VIS_NODE_H
...
class CVtkFixedPointVolumeRayCastMapper : public CVtkVolumeMapper
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkFixedPointVolumeRayCastMapper();
    ~CVtkFixedPointVolumeRayCastMapper();
...
private:
    CVtkFixedPointVolumeRayCastMapperData* d;
};
