...
#ifndef CVTKOPENGLVOLUMETEXTUREMAPPER3D_VIS_NODE_H
#define CVTKOPENGLVOLUMETEXTUREMAPPER3D_VIS_NODE_H
...
class CVtkOpenGLVolumeTextureMapper3D : public CVtkVolumeTextureMapper3D
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkOpenGLVolumeTextureMapper3D();
    ~CVtkOpenGLVolumeTextureMapper3D();
...
private:
    CVtkOpenGLVolumeTextureMapper3DData* d;
};
