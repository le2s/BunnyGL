...
#ifndef CVTKPROJECTEDTETRAHEDRAMAPPER_VIS_NODE_H
#define CVTKPROJECTEDTETRAHEDRAMAPPER_VIS_NODE_H
...
class CVtkProjectedTetrahedraMapper : public CVtkUnstructuredGridVolumeMapper
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    ...
    void setUseScalarMode(ScalarMode mode);
    ScalarMode useScalarMode() const;
...
private:
    CVtkProjectedTetrahedraMapperData* d;
};
