...
#ifndef CVTKUNSTRUCTUREDGRIDBUNYKRAYCASTFUNCTION_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDBUNYKRAYCASTFUNCTION_VIS_NODE_H
...
class CVtkUnstructuredGridBunykRayCastFunction : public CVtkUnstructuredGridVolumeRayCastFunction
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridBunykRayCastFunction();
    ~CVtkUnstructuredGridBunykRayCastFunction();
...
private:
    CVtkUnstructuredGridBunykRayCastFunctionData* d;
};
