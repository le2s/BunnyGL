...
#ifndef CVTKUNSTRUCTUREDGRIDHOMOGENEOUSRAYINTEGRATOR_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDHOMOGENEOUSRAYINTEGRATOR_VIS_NODE_H
...
class CVtkUnstructuredGridHomogeneousRayIntegrator : public CVtkUnstructuredGridVolumeRayIntegrator
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_PROPERTY(int TransferFunctionTableSize READ transferFunctionTableSize WRITE setTransferFunctionTableSize)

public:
    CVtkUnstructuredGridHomogeneousRayIntegrator();
    ~CVtkUnstructuredGridHomogeneousRayIntegrator();

    void setTransferFunctionTableSize(int val);
    int transferFunctionTableSize() const;
...
private:
    CVtkUnstructuredGridHomogeneousRayIntegratorData* d;
};
