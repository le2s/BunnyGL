...
#ifndef CVTKUNSTRUCTUREDGRIDLINEARRAYINTEGRATOR_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDLINEARRAYINTEGRATOR_VIS_NODE_H
...
class CVtkUnstructuredGridLinearRayIntegrator : public CVtkUnstructuredGridVolumeRayIntegrator
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridLinearRayIntegrator();
    ~CVtkUnstructuredGridLinearRayIntegrator();
...
private:
    CVtkUnstructuredGridLinearRayIntegratorData* d;
};
