...
#ifndef CVTKUNSTRUCTUREDGRIDPARTIALPREINTEGRATION_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDPARTIALPREINTEGRATION_VIS_NODE_H
...
class CVtkUnstructuredGridPartialPreIntegration : public CVtkUnstructuredGridVolumeRayIntegrator
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridPartialPreIntegration();
    ~CVtkUnstructuredGridPartialPreIntegration();
...
private:
    CVtkUnstructuredGridPartialPreIntegrationData* d;
};
