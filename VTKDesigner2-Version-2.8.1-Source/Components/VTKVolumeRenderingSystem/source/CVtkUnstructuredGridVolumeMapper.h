...
#ifndef CVTKUNSTRUCTUREDGRIDVOLUMEMAPPER_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDVOLUMEMAPPER_VIS_NODE_H
...
class CVtkUnstructuredGridVolumeMapper : public CVtkAbstractVolumeMapper
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridVolumeMapper();
    ~CVtkUnstructuredGridVolumeMapper();
...
private:
    CVtkUnstructuredGridVolumeMapperData* d;
};
