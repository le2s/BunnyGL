...
#ifndef CVTKUNSTRUCTUREDGRIDVOLUMERAYCASTFUNCTION_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDVOLUMERAYCASTFUNCTION_VIS_NODE_H
...
class CVtkUnstructuredGridVolumeRayCastFunction : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridVolumeRayCastFunction();
    ~CVtkUnstructuredGridVolumeRayCastFunction();
...
private:
    CVtkUnstructuredGridVolumeRayCastFunctionData* d;
};
