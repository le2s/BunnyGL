...
#ifndef CVTKUNSTRUCTUREDGRIDVOLUMERAYCASTMAPPER_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDVOLUMERAYCASTMAPPER_VIS_NODE_H
...
class CVtkUnstructuredGridVolumeRayCastMapper : public CVtkUnstructuredGridVolumeMapper
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridVolumeRayCastMapper();
    ~CVtkUnstructuredGridVolumeRayCastMapper();
...
private:
    CVtkUnstructuredGridVolumeRayCastMapperData* d;
};
