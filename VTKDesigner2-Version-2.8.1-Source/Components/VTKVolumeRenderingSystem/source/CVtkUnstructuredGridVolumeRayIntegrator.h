...
#ifndef CVTKUNSTRUCTUREDGRIDVOLUMERAYINTEGRATOR_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDVOLUMERAYINTEGRATOR_VIS_NODE_H
...
class CVtkUnstructuredGridVolumeRayIntegrator : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridVolumeRayIntegrator();
    ~CVtkUnstructuredGridVolumeRayIntegrator();
...
private:
    CVtkUnstructuredGridVolumeRayIntegratorData* d;
};
