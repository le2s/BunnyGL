...
#ifndef CVTKUNSTRUCTUREDGRIDVOLUMEZSWEEPMAPPER_VIS_NODE_H
#define CVTKUNSTRUCTUREDGRIDVOLUMEZSWEEPMAPPER_VIS_NODE_H
...
class CVtkUnstructuredGridVolumeZSweepMapper : public CVtkUnstructuredGridVolumeMapper
#ifdef ENABLE_ADVANCED_PROPERTIES
...
public:
    CVtkUnstructuredGridVolumeZSweepMapper();
    ~CVtkUnstructuredGridVolumeZSweepMapper();
...
private:
    CVtkUnstructuredGridVolumeZSweepMapperData* d;
};
