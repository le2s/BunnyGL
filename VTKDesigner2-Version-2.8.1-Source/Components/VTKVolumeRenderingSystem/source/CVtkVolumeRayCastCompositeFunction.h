...
#ifndef CVTKVOLUMERAYCASTCOMPOSITEFUNCTION_VIS_NODE_H
#define CVTKVOLUMERAYCASTCOMPOSITEFUNCTION_VIS_NODE_H
...
class CVtkVolumeRayCastCompositeFunction : public CVtkVolumeRayCastFunction
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_ENUMS(CompositeMethod)
    Q_PROPERTY(CompositeMethod CompositeMethod READ compositeMethod WRITE setCompositeMethod)

public:
    CVtkVolumeRayCastCompositeFunction();
    ~CVtkVolumeRayCastCompositeFunction();
    ...
    void setCompositeMethod(CompositeMethod m);
    CompositeMethod compositeMethod() const;
...
private:
    CVtkVolumeRayCastCompositeFunctionData* d;
};
