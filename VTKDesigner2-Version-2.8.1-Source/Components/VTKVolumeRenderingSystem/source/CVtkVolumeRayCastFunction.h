...
#ifndef CVTKVOLUMERAYCASTFUNCTION_VIS_NODE_H
#define CVTKVOLUMERAYCASTFUNCTION_VIS_NODE_H
...
class CVtkVolumeRayCastFunction : public CGenericVisNodeBase
#ifdef ENABLE_ADVANCED_PROPERTIES
...
private:
    CVtkVolumeRayCastFunctionData* d;
};
