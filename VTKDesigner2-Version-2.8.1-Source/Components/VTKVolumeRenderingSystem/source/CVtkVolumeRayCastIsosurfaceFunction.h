...
#ifndef CVTKVOLUMERAYCASTISOSURFACEFUNCTION_VIS_NODE_H
#define CVTKVOLUMERAYCASTISOSURFACEFUNCTION_VIS_NODE_H
...
class CVtkVolumeRayCastIsosurfaceFunction : public CVtkVolumeRayCastFunction
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_PROPERTY(double IsoValue READ isoValue WRITE setIsoValue)

public:
    CVtkVolumeRayCastIsosurfaceFunction();
    ~CVtkVolumeRayCastIsosurfaceFunction();
...
private:
    CVtkVolumeRayCastIsosurfaceFunctionData* d;
};
