...
#ifndef CVTKVOLUMERAYCASTMIPFUNCTION_VIS_NODE_H
#define CVTKVOLUMERAYCASTMIPFUNCTION_VIS_NODE_H
...
class CVtkVolumeRayCastMIPFunction : public CVtkVolumeRayCastFunction
#ifdef ENABLE_ADVANCED_PROPERTIES
...
#endif
{
    ...
    Q_ENUMS(MaximizeMethod);
    Q_PROPERTY(MaximizeMethod MaximizeMethod READ maximizeMethod WRITE setMaximizeMethod)

public:
    CVtkVolumeRayCastMIPFunction();
    ~CVtkVolumeRayCastMIPFunction();
    ...
    void setMaximizeMethod(MaximizeMethod m);
    MaximizeMethod maximizeMethod() const;
...
private:
    CVtkVolumeRayCastMIPFunctionData* d;
};
