...
#ifndef VTKVOLUMERENDERINGSYSTEM_COMPONENT_H
#define VTKVOLUMERENDERINGSYSTEM_COMPONENT_H
...
class VTKVolumeRenderingSystemComponent : public GCF::AbstractComponent,
                                 virtual public IVisSystemNodeFactory,
                                 virtual public IAboutData
{
    Q_OBJECT
    Q_INTERFACES(IVisSystemNodeFactory IAboutData)
    GCF_DECLARE_COMPONENT(VTKVolumeRenderingSystemComponent)

public:
    static VTKVolumeRenderingSystemComponent & instance();
    ~VTKVolumeRenderingSystemComponent();
...
private:
    VTKVolumeRenderingSystemComponentData* d;
};
