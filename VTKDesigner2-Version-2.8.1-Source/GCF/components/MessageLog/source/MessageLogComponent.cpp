...
\class GCF::Components::MessageLogComponent
...
GCF::Components::MessageLogComponent::MessageLogComponent()
{
    ...
    connect(this, SIGNAL(debugMessageReceived(const QString&)), this, SLOT(_debugMessage(const QString&)), Qt::QueuedConnection);
    connect(this, SIGNAL(warningMessageReceived(const QString&)), this, SLOT(_warningMessage(const QString&)), Qt::QueuedConnection);
    connect(this, SIGNAL(criticalMessageReceived(const QString&)), this, SLOT(_criticalMessage(const QString&)), Qt::QueuedConnection);
    connect(this, SIGNAL(fatalMessageReceived(const QString&)), this, SLOT(_fatalMessage(const QString&)), Qt::QueuedConnection);
}
...
void GCF::Components::MessageLogComponent::_debugMessage(const QString& msg)
{
    if(d->debug)
    {
        d->debug->append(msg);
...
{
    emit warningMessageReceived(msg);
}

void GCF::Components::MessageLogComponent::_warningMessage(const QString& msg)
{
    if(d->warning)
    {
...
{
    emit criticalMessageReceived(msg);
}

void GCF::Components::MessageLogComponent::_criticalMessage(const QString& msg)
{
    if(d->critical)
    {
...
{
    emit fatalMessageReceived(msg);
}

void GCF::Components::MessageLogComponent::_fatalMessage(const QString& msg)
{
    if(d->fatal)
    {
        d->fatal->append(msg);
