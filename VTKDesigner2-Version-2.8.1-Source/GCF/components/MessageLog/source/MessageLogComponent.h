...
protected slots:
    void _debugMessage(const QString& msg);
    void _warningMessage(const QString& msg);
    void _criticalMessage(const QString& msg);
    void _fatalMessage(const QString& msg);

signals:
    void debugMessageReceived(const QString& msg);
    void warningMessageReceived(const QString& msg);
    void criticalMessageReceived(const QString& msg);
    void fatalMessageReceived(const QString& msg);
