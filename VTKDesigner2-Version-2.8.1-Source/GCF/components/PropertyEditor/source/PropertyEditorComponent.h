...
#include <IQObjectLoadSave>
#include <IDefaultValueEditorFactory>
...
class PropertyEditorComponent : public AbstractComponent, virtual public IAboutData,
                                ...
                                virtual public IDefaultValueEditorFactory
{
    Q_OBJECT
    Q_INTERFACES(IAboutData IQObjectLoadSave IDefaultValueEditorFactory)
...
public:
    // IQObjectLoadSave implementation
    ...
    // IDefaultValueEditorFactory implementation
    IValueEditorFactory* valueEditorFactory() const;
