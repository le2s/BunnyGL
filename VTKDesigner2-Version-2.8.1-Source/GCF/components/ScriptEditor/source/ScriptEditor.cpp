...
:QTextEdit(parent)
{
    ...
    d->highlighter = new GCF::Components::ScriptHighlighter(this);
...
QSyntaxHighlighter* GCF::Components::ScriptEditor::highlighter() const
{
    return d->highlighter;
}

void GCF::Components::ScriptEditor::setHighlighter(QSyntaxHighlighter* h)
{
    if(!h || d->highlighter == h)
        return;
...
void GCF::Components::ScriptEditor::setDefaultHighlighter()
{
    if(qobject_cast<GCF::Components::ScriptHighlighter*>(d->highlighter))
        return;
...
QSyntaxHighlighter* GCF::Components::ScriptEditor::newDefaultHighlighter() const
{
    return new GCF::Components::ScriptHighlighter( &GCF::Components::ScriptEditorComponent::instance() );
}
...
GCF::Components::ScriptHighlighter::ScriptHighlighter(QObject *parent)
...
GCF::Components::ScriptHighlighter::~ScriptHighlighter()
{

}

void GCF::Components::ScriptHighlighter::init()
{
