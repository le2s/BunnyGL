...
class ScriptEditor : public QTextEdit, virtual public IProjectPart,
        virtual public IScriptHighlighter
{
    Q_OBJECT
    Q_INTERFACES(IProjectPart IScriptHighlighter)
...
public:
    // IScriptHighlighter implementation
    QSyntaxHighlighter* highlighter() const;
    void setHighlighter(QSyntaxHighlighter* h);
    void setDefaultHighlighter();
    QSyntaxHighlighter* newDefaultHighlighter() const;
...
public:
    ScriptHighlighter(QObject* parent);
