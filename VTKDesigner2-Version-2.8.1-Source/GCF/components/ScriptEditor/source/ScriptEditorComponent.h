...
class ScriptEditorComponent : public AbstractComponent,
        ...
        virtual public IScriptEngineLoadFormContainerDatabase
{
    Q_OBJECT
    Q_INTERFACES(IProjectPart IAboutData IConfigurationDialogPageProvider IScriptEngineLoadFormContainerDatabase)
...
public:
    ...
    // IScriptEngineLoadFormContainerDatabase implementation
    void addLoadFormContainer(QWidget* widget, const QString& completeName);
    void removeLoadFormContainer(QWidget* widget);
    void changeLoadFormContainer(QWidget* widget, const QString& completeName);
    int loadFormContainerCount() const;
    QWidget* loadFormContainerWidgetAt(int index) const;
    QString loadFormContainerNameAt(int index) const;
