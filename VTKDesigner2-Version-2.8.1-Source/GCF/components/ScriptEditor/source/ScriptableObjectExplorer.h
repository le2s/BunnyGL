...
#include "IScriptableObjectExplorerExt.h"
...
class ScriptableObjectExplorer : public QTreeWidget,
        ...
        virtual public IScriptableObjectExplorerExt
{
    Q_OBJECT
    Q_INTERFACES(IScriptableObjectExplorer IScriptableObjectExplorerExt)
...
signals:
    ...
    // IScriptableObjectExplorerExt implementation
public:
    void updateExplorer(bool updateOldObjects);
