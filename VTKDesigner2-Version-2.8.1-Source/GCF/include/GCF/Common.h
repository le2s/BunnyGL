...
// If GCF_ACTIVEQT_AVAILABLE is defined, then you can use ActiveX merging
...
#else
#undef GCF_ACTIVEQT_AVAILABLE
#endif
#endif
#endif

// August 12, 2008. @Akademy 2008, Akonadi/KOffice Den
// Check for GCF_KPARTS_AVAILABLE macro here. This #define is set
